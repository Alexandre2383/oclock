    ...
    (async () => {
      try {
        ...
        await addResourcesToCache([
          ...
          './assets/icons/ash.png',
          './assets/icons/clear.png',
          './assets/icons/clouds.png',
          './assets/icons/drizzle.png',
          './assets/icons/dust.png',
          './assets/icons/icons8-alarm-clock-100.png',
          './assets/icons/icons8-arrow-up-64.png',
          './assets/icons/icons8-clock-100.png',
          './assets/icons/icons8-hourglass-100.png',
          './assets/icons/icons8-start-skin-type-2-96.png',
          './assets/icons/icons8-stop-gesture-96.png',
          './assets/icons/icons8-stopwatch-100.png',
          './assets/icons/icons8-time-100.png',
          './assets/icons/unknow.png',
          './assets/icons/tornado.png',
          './assets/icons/thunderstorm.png',
          './assets/icons/thunder.png',
          './assets/icons/squall.png',
